...
complete -c openclaw -n "__fish_seen_subcommand_from list" -l channel -d 'Channel (discord)'
...
complete -c openclaw -n "__fish_seen_subcommand_from approve" -l channel -d 'Channel (discord)'
